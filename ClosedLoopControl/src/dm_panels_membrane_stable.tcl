...
proc closeLoopPanel {} {
  ...
  button .cl.f.clb.poke -text "Poke DM..." -command { MDM_GUI }
...
proc MDM_GUI {} {
  ...
  frame  .mdm.f.buts
  frame	 .mdm.f.stub
  button .mdm.f.buts.flat -text "Zero MDM" -command FlatMDM
  button .mdm.f.stub.save -text "Save Settings..." -command SaveMDM
  button .mdm.f.stub.load -text "Load Settings..." -command LoadMDM
  button .mdm.f.stub.zerl -text "Reset Zeros File ..." -command ResetZMDM
