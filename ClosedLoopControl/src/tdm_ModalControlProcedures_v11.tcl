...
proc trainSemiAutoDMForModalControl { } \
{
   ...
   #DEBUG
   #puts "trainSemiAutoDMForModalControl: theIBinWidth = $theIBinWidth"
   #puts "trainSemiAutoDMForModalControl: theJBinWidth = $theJBinWidth"
   #puts "trainSemiAutoDMForModalControl: XACT_LINE_LENGTH = $XACT_LINE_LENGTH"
   #puts "trainSemiAutoDMForModalControl: YACT_LINE_LENGTH = $YACT_LINE_LENGTH"
