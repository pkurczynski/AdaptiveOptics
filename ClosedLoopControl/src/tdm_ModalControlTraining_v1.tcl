...
proc getXYPositionOfBinnedActuator { inIJA outXYA_mm } \
{
   global gActuatorPositionV4

   upvar $outXYA_mm theXYA_mm
   upvar $inIJA theIJA

   a.cols gActuatorPositionV4 = theNumColsA
   set theNumCols [a.dump theNumColsA]

   for { set k 0 } { $k < $theNumCols } { incr k } {
        a.extele gActuatorPositionV4 $k = theTestActuatorPositionV4
