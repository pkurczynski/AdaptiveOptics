...
proc calibrateFirstTestActuator { } \
{
    ...
    calibrateTestActuator gFirstTestActuatorCol \
                          gFirstTestActuatorRow \
...
proc calibrateSecondTestActuator { } \
{
    ...
    # columns are "i" values, rows are "j" values in wavescope software
    calibrateTestActuator gSecondTestActuatorCol \
                          gSecondTestActuatorRow \
...
# testStub
#
# Test procedure for trainSemiAutoDMForModalControl
#
# executing trainSemiAutoDMForModalControl after this
...
# 5/19/2005
#---------------------------------------------------------------------------
proc trainSemiAutoDMForModalControl { } \
{
   global gFirstTestActuatorPositionV4
   global gSecondTestActuatorPositionV4
   global gModalControlNumberOfActuatorsPerBin
   ...
   a.div theDx theDi = theMf
   a.div theDy theDj = theMg

   a.v4tov2v2 gFirstTestActuatorPositionV4 = theFijV2 theFxyV2
   a.v2toxy theFijV2 = theFi theFj
   a.v2toxy theFxyV2 = theFx theFy

   a.mul theMf theFi = theTempi
   a.mul theMg theFj = theTempj

   a.sub theFx theTempi = theBf
   a.sub theFy theTempj = theBg
   ...
   for { set i 0 } { $i < $XACT_LINE_LENGTH } { incr i $theIBinWidth } {
        for { set j 0 } { $j < $YACT_LINE_LENGTH } { incr j $theJBinWidth } {
                ...
                a.mul theMf theiA = theTempi
                a.mul theMg thejA = theTempj
   ...
   #DEBUG
   puts stdout "trainSemiAutoDMForModalControl: completed"
   set gTrainDMForModalControlFlag 1
...
# wavefront taken with the wavescope device.
#
...
proc displayActuatorGridAndWavefront { } \
{
    ...
    id.set.title ACTUATORGRIDANDWAVEFRONT_ID "Wavefront. East is Up"
	...
	return
        ...
        a.xytov2 theRectWidth theRectHeight = theWHV2
        a.xytov2 theHalfWidth theHalfHeight = theHalfWHV2
        a.copy theXYV2 = theSubTermV2
        a.set theSubTermV2 theHalfWHV2 = theSubTermV2
        a.sub theXYV2 theSubTermV2 = theXYUpperLeftV2

        a.v2v2tov4 theXYUpperLeftV2 theWHV2 = theGridRectV4
