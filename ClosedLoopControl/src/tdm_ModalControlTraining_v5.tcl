                                             ...
                                             inMembraneVoltage } \
{
    ...
    testWavefrontComputation theWavefrontF



    # alternate method:  Zernike series computation
    ...
    EvaluateWavefrontAndLaplacianAtPosition theX_ImagPix  \
                                            theY_ImagPix \
                                            theWavefront_um \
...
# 6/29/2005
#------------------------------------------------------------------------
proc testWavefrontComputation { inWavefrontF } \
{
...
# 6/29/2005
#------------------------------------------------------------------------
proc EvaluateWavefrontAndLaplacianAtPosition { inX_ImagPix  \
                                               inY_ImagPix \
