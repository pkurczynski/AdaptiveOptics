...
proc generateBesselWavefront { } \
{
   ...
   a.extele wlCalibrate(Pupil) 0 = theXCenter_pix
   a.extele wlCalibrate(Pupil) 1 = theYCenter_pix

   a.sub theXCoord_pix theXCenter_pix = theRelXCoord_pix
   a.sub theYCoord_pix theYCenter_pix = theRelYCoord_pix

   a.sq theRelXCoord_pix = theX2_pix
   a.sq theRelYCoord_pix = theY2_pix
   ...
   set theMembraneRadius_pix [a.dump thePupilRadius_pixA]
   ...
   lookupBesselIndicesAndZero $gEigenModeJIndex_int theV theN theXvn
   ...
   set theNDenomFact2 [bessj1 $theXvn]
   ...
   set theNumXValues [a.dump theNumXValuesA]
   ...
   for { set i 0 } { $i < $theNumXValues } { incr i } {
             ...
             a.extele theY2_pix $i = theCY2_pix
             ...
             set theSCR_dimless [a.dump theSCR_dimlessA]
             ...
             set theBessjValue_dimless [bessj0 $theArg]
   ...
   alg.conv.pg.arrays theWavefrontOPD_umV4 \
                      wlCalibrate(Params) \
                      = theWavefrontOPD_um2DV2 theWavMaskArray

   a.v2toxy theWavefrontOPD_um2DV2 \
            = theWavefrontOPD_um2DFloat theWavefrontOPD_um2DFloat_Dummy

   # interpolate zero values
   #DEBUG
   puts "generateBesselWavefront: theWavefrontOPD_um2DFloat"
   puts "[a.info theWavefrontOPD_um2DFloat]"
   a.saveasc theWavefrontOPD_um2DFloat theWavefrontOPD_um2DFloat.txt

   puts "generateBesselWavefront: theWavMaskArray"
   puts "[a.info theWavMaskArray]"
   a.saveasc theWavMaskArray theWavMaskArray.txt

   # fillmask doesn't work here:  Arrays are incompatible error.
   # possibly due to zeros in array "outside the maximum radius" that
   # fill the square wavefront.  plk 9/28/2005
   #a.fillmask theWavefrontOPD_um2DFloat \
   #           theWavMaskArray \
   #           = theWavefrontOPD_um2DSmoothFloat

   #DEBUG
   #puts stdout "generateBesselWavefront:  outputing data to ascii files"
   #a.saveasc theWavefrontOPD_umV4 theWavefrontOPD_umV4.txt
   #a.saveasc theWavefrontOPD_um2DV2 theWavefrontOPD_um2DV2.txt

   a.copy theWavefrontOPD_um2DSmoothFloat = gUserDefWavefrontOPD_float_um
