...
proc commandDMToUserDefWavefront { } \
{
	...
	update
        ...
        # subtract measured wavefront from desired wavefront
        # Grad here is the gradient of the wavefront.  Why
        # was it used in closedloop, rather than wavefront itself?
        # plk 1/3/2005
        #a.sub Grad gUserDefWavefront_float_um = Grad
...
proc displayWavefront { } \
{
   ...
   wd.set.xy USERDEF_OPD_WD 5 200
   wd.set.wh USERDEF_OPD_WD 350 350
