...
proc closeloop {} {
	...
	#
        ...
        # calcGrad grabs (3) images from wavefront sensor, averages
        # them and stores the gradients in the Grad array.  plk 12/22/2004
	calcGrad 3

        # these procedures compute the opd from the gradient data and
        # spot reference position data taken during calibration.
        # plk 12/22/2004
	alg.conv.pg.arrays Grad wlCalibrate(Params) = gxgy mask
	alg.recon.fast gxgy mask = opd
