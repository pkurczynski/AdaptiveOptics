...
#    a.saveasc $ModFlg Modflg
  ...
  puts "Completed first conditional."
  #
 ...
 a.saveasc $Wmask Wmask
   ...
   if { $ModFlg == "Mod" } \
   {
     ...
     a.saveasc $mrat mrat
     a.saveasc $Wmask Wmask
  puts "Completed second conditional."
...
proc mdm_panel {} {
	...
	load C:/hdyson/Incoming/Merged_DMTCL_Version_4/DMTCL.dll
	rename mdm.help dm.help
	rename mdm.send dm.send
	rename mdm.poke dm.poke
	rename mdm.pokeraw dm.pokeraw
...
#Strictly unstable testing code below:
