...
# center of wavefront in findpeak display window.  Set in
# registerCoordsForModalControl
global gFindPeakDisplayCenterPositionV4
...
proc registerCoordsForModalControl { } \
{
    ...
    calibrateTestActuator theDummyCol \
                          theDummyRow \
                          gFindPeakDisplayCenterPositionV4

    #DEBUG
    puts stdout "registerCoordsForModalControl:"
    puts stdout "[a.dump gFindPeakDisplayCenterPositionV4]"
