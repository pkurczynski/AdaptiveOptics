...
# source c:/usr/aos/wavescope/src/scripts/test_scroll.tcl      
#       puts stdout "Diagnostics begin:"
#       puts stdout "6"
#       puts stdout [ $w:vleft ]
#       puts stdout "7"
#       puts stdout [ $($w:vleft) ]
...
#       puts stdout "7"
#       puts stdout [ $($w:vleft) ]
#       puts stdout "Diagnostics end"

    # save old values
      set _vleft $($w:vleft)
      set _vwidth $($w:vwidth)
    set _width [winfo width $w]
puts stdout "_vleft $_vleft _vwidth $_vwidth _width $_width"
    # compute new vleft
    set count ""
    switch $len \
    {
