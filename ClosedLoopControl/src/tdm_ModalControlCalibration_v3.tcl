...
# Conversion factor from "wavefront pixel" coordinates to "image pixel"
# coordinates.  See registerCoordsForModalControl
global gWavPixToImagPixV2
...
# display window with coordinates used in wavescope calibration.
#
...
proc registerCoordsForModalControl { } \
{
...
    a.make "<0 0 0 0>" = theFindPeakDisplayCenterPositionV4
    ...
    a.inv theCenterXY_WavPixV2 = theInvCenterXY_WavPixV2
    ...
    a.xytov2 theCenterColX_ImagPixA \
             theCenterRowY_ImagPixA \
             = theCenterXY_ImagPixV2
    ...
    # by this vector V2 to convert them to coordinates
    # compatible with wavescope wavefront computations.
    a.mul theCenterXY_ImagPixV2 \
          theInvCenterXY_WavPixV2
          = gWavPixToImagPixV2
