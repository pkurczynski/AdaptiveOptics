...
# span the range [1,37].
#
# To register the procedures in this file with the wavescope
# software, so that they are accessible from the Tk console
# of wavescope operated in "Expert" mode, modify the file
#
# C:\wavescope\usr\aos\wavescope\scripts\tclIndex.tcl
#
# by adding the line:
# set auto_index(tdm_init) 
#   [list source [file join $dir ActuateTEMembraneDevice.tcl]]  
#
# then execute the command tdm_init from the wavescope Tk
...
proc ActuateSouthChipSector {inHDColumn inVoltage} {
     ...
     for {set i 1} {$i <= $inHDColumn } {incr i} {
        ...
        #DEBUG statement
        #puts stdout "The current value of the loop index is $i."
