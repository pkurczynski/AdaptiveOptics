...
proc makerecon {} \
	...
	a.transpose U = Ut
        ...
        # save SVD weight array.
        a.rows W = theNumWRows
        a.cols W = theNumWCols

        set theFile "svdWeightBeforeThresh.txt"
        puts stdout "makerecon:  saving weight array to file - $theFile"
        puts stdout "   [a.dump theNumWRows] rows x [a.dump theNumWCols] cols"
        a.saveasc $W $theFile
