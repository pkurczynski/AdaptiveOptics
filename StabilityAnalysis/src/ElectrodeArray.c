...
void ComputeElectrodeVoltage()
{
   ...
   int theComputeErr   = 0;
   char theMessage[100];
   static double theVoltageT_V;

   theVoltageT_V = gVoltageT_V;
   ...
   // reset gVoltageT_V to its original value, before being
   // possibly bumped up by this procedure
   gVoltageT_V = theVoltageT_V;
